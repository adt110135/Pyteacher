...
openai.api_key = 'sk-proj-ckq9yJ9XHG69NzjskzzrT3BlbkFJRVQTSMoROhF7GPIwh3o2'
...
def chat():
    ...
    response = openai.ChatCompletion.create(
        model="ft:gpt-3.5-turbo-0125:personal::9RFMl55Q",
...
def quick_chat():
    system_responses = [
        {"role": "system", "content": "請幫我出一題python問題"}
    ]
